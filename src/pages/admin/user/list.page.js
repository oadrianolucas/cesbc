...
import { allUsers, listUsers, findUser } from "@/pages/api/cursosesportivos";
...
export default function UsersPage() {
  ...
  const endPage = Math.min(Math.ceil(totalUsers / 10), currentPage + halfLimit);
  ...
  useEffect(() => {
    fetchUsers(currentPage), fetchTotalUsers();
  }, [currentPage]);
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    {endPage < Math.ceil(totalUsers / 10) && (
                      <span
                        className="relative inline-flex items-center px-4
